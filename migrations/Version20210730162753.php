 ...
 */
final class Version20210730162753 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE attach_nashiraboty (id INT AUTO_INCREMENT NOT NULL, nashiraboty_id INT DEFAULT NULL, image VARCHAR(255) NOT NULL, created_at DATETIME DEFAULT NULL, updated_at DATETIME DEFAULT NULL, description LONGTEXT DEFAULT NULL, INDEX IDX_D810F4F97553B578 (nashiraboty_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE content DROP FOREIGN KEY content_ibfk_1');
        $this->addSql('ALTER TABLE content DROP FOREIGN KEY content_ibfk_1');
        ...
        $this->addSql('ALTER TABLE price__services DROP FOREIGN KEY price__services_ibfk_1');
        $this->addSql('ALTER TABLE price__services CHANGE price_category_id price_category_id INT NOT NULL, CHANGE published published TINYINT(1) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE attach_nashiraboty');
